...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2024 at 12:53 AM
...
(3, 'Marek', 'Biedron', 'biedron@bilmame.com', '6984598342', 'Warszawa', 'ul. Nowy Świat 10'),
(4, 'Bastian', 'Obsztyfikultykiewicz', 'bastian.obsztyfikultykiewicz@rudy.com', '997997997', 'Warszawa', 'ul. Grochowska 997'),
(54, 'disauhbdu', 'fuisabfiusa', 'osdfeu@fasdfb', '123456789', 'idsaf', 'oifnsdo'),
(58, 'Mario', 'Cypek', 'cypek@gmial.com', '123443211', 'Szczecin', 'wilcza-5'),
(63, 'Adrian', 'Puchacki', 'adi@spejson.pl', '669989676', 'Warszawa', 'steryda-10'),
(65, 'Mario', 'Tupak', 'Tupak@gmail.com', '213456432', 'Warszawa', 'Dzielna-3'),
(79, '', '', '', '', '', ''),
(86, 'Dariusz', 'Dawid', 'bartdaw@gmail.com', '213769420', 'Rudziniec', 'Maiami-3');
...
INSERT INTO `szczegółyzamówienia` (`id_zamówienia`, `id_produktu`, `ilość`, `Rozmiar`) VALUES
(2, 4, 2, 45),
(3, 5, 2, 41),
(3, 1, 3, 43),
(4, 8, 1, 43),
...
--
ALTER TABLE `klienci`
  MODIFY `id_klienta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
...
--
ALTER TABLE `zamówienia`
  MODIFY `id_zamówienia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
